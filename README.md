...
**OBS: Para ativar a automação por tempo ou por % de memória em uso, selecione a caixa da opção desejada, selecione qual uma opção na cascata e clique em iniciar.**
